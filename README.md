...
**[Quick Start Guide](STREAMLIT_DEPLOY.md)** | **[Research Paper](docs/research_paper_draft.md)** | **[Models Documentation](models/README.md)**
...
| Model | Execution Accuracy | Latency | Cost/1k queries |
|-------|-------------------|---------|-----------------|
| **GPT-4 (baseline)** | 85.4% | 1200ms | $15.00 |
| **GPT-4o-mini (FT)** | **83.5%** | 800ms | $0.30 |
| **Llama-3-8B (FT)** | **78.2%** | 450ms | Free |
| **Gemma-7B (FT)** | **76.0%** | 500ms | Free |

**Key Findings:**
- Fine-tuned GPT-4o-mini achieves 97.8% of GPT-4 accuracy at 2% of the cost
- Domain-specific fine-tuning improves accuracy by 3-6% across all models

**[View Full Research Paper](docs/research_paper_draft.md)**  
**[Fine-Tuned Models Documentation](models/README.md)**  
